...
class DeviceApi {
  ...
  Future<Response<BuiltList<String>>> getDevices({ 
    int? skip,
    int? limit,
  ...
  Future<Response<void>> register({ 
    ...
    try {
      const _type = FullType(DeviceRegistrationInfo);
      _bodyData = deviceRegistrationInfo == null ? null : _serializers.serialize(deviceRegistrationInfo, specifiedType: _type);
